...
describe(`connectionFromArray()`, () => {
  ...
  describe(`basic slicing`, () => {
    ...
    it(`respects a smaller first`, () => {
      const c = (0, _arrayconnection.connectionFromArray)(letters, { limit: 2 });
      return expect(c).toEqual({
        edges: [{
          node: `A`,
          next: `B`,
    ...
    it(`respects an overly large first`, () => {
      const c = (0, _arrayconnection.connectionFromArray)(letters, { limit: 10 });
      return expect(c).toEqual({
        edges: [{
          next: `B`,
          node: `A`,
  ...
  describe(`pagination`, () => {
    it(`respects limit and skip`, () => {
      const c = (0, _arrayconnection.connectionFromArray)(letters, { limit: 2, skip: 2 });
      return expect(c).toEqual({
        edges: [{
          next: `D`,
          node: `C`,
    ...
    it(`respects limit and skip with large skip`, () => {
      const c = (0, _arrayconnection.connectionFromArray)(letters, { limit: 10, skip: 2 });
      return expect(c).toEqual({
        edges: [{
          next: `D`,
          node: `C`,
...
describe(`connectionFromPromisedArray()`, () => {
  ...
  it(`returns all elements without filters`, async () => {
    const c = await (0, _arrayconnection.connectionFromPromisedArray)(letters, {});
    return expect(c).toEqual({
      edges: [{
        next: `B`,
        node: `A`,
  ...
  it(`respects a smaller first`, async () => {
    const c = await (0, _arrayconnection.connectionFromPromisedArray)(letters, { limit: 2 });
    return expect(c).toEqual({
      edges: [{
        next: `B`,
        node: `A`,
