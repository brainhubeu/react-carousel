...
export default class PerPagePage extends Component {
  render() {
    return (
      <NavLayout>
        <Section title="Draggable" description="Carousel is draggable by default. You can disable this option by setting draggable={false} and change it's behaviour with option keepDirectionWhenDragging" code={code}>
          <Carousel
            slidesPerPage={4}
            keepDirectionWhenDragging
          >
