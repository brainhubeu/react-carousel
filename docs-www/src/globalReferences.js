const { default: Carousel, Dots, slidesPerPagePlugin, infinitePlugin, clickToChangePlugin, autoplayPlugin, rtlPlugin } = (() => {
  if (!global.window) {
    global.window = {};
  }
...
export { Carousel, Dots, slidesPerPagePlugin, infinitePlugin, clickToChangePlugin, autoplayPlugin, rtlPlugin, Icon, imageOne, imageTwo, imageThree, thumbnailOne, thumbnailTwo, thumbnailThree };
