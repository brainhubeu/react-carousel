const { default: Carousel, Dots, slidesPerPagePlugin, infinitePlugin, clickToChangePlugin, autoplayPlugin, rtlPlugin, centeredPlugin, slidesPerScrollPlugin } = (() => {
  if (!global.window) {
    global.window = {};
  }
...
export { Carousel, Dots, slidesPerPagePlugin, infinitePlugin, clickToChangePlugin, autoplayPlugin, rtlPlugin, centeredPlugin, slidesPerScrollPlugin, Icon, imageOne, imageTwo, imageThree, thumbnailOne, thumbnailTwo, thumbnailThree };
