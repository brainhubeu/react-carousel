const { default: Carousel, Dots, slidesPerPagePlugin, infinitePlugin } = (() => {
  if (!global.window) {
    global.window = {};
  }
...
export { Carousel, Dots, slidesPerPagePlugin, infinitePlugin, Icon, imageOne, imageTwo, imageThree, thumbnailOne, thumbnailTwo, thumbnailThree };
